          ...
          <div className="relative z-10 w-full max-w-md animate-modal-in">
            <div className="relative bg-white rounded-2xl shadow-2xl border border-purple-100 overflow-hidden">
              ...
              <div className="px-6 py-4 bg-slate-50 border-t border-slate-100 flex gap-3">
                ...
                <button
                  className="flex-1 py-2.5 rounded-full bg-gradient-to-r from-emerald-400 to-blue-500 hover:opacity-90 text-white font-medium transition-all duration-300"
